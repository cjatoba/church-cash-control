...
export function CategoryForm({
  ...
  return (
    ...
    >
      ...
      {state.success ? (
        <div className="flex flex-col gap-2 rounded bg-green-50 p-3 dark:bg-green-950/30">
          <p className="text-sm text-green-600 dark:text-green-400">
            Categoria criada com sucesso. Cadastre outra abaixo ou volte para o painel.
          </p>
          <Link
            href="/"
            className="self-start text-sm font-medium text-zinc-700 underline hover:text-black dark:text-zinc-300 dark:hover:text-zinc-50"
          >
