...
ALTER TABLE "loose_pledges" ADD CONSTRAINT "loose_pledges_donor_id_donors_id_fk" FOREIGN KEY ("donor_id") REFERENCES "public"."donors"("id") ON DELETE cascade ON UPDATE no action;